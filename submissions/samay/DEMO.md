...
| Min | Show | Say |
|---|---|---|
| 0:00–1:00 | Title + KPI row (sample docket, 3,000 cases) | "One judge, cheque-bounce cases, the court's real day: start 10:30–11, lunch 12:30–1:30, rise at 5, two minutes between hearings. Today's court lists 60, reaches ~12, moves ~8 — our simulator reproduces that from your data. Samay: ~22 listed, ~15 heard, ~14 move forward — and 3× as many cases finished in 60 days (407 vs 127), with a seventh of the wasted trips." |
...
| 5:15–5:45 | Rankers tab | "Our first ranker maximised hearings that move; our teammate's 0-100 score maximised cases finished. The hybrid keeps nearly all the disposals with the fewest wasted trips — and every score explains itself: age, readiness, near the end, churn, urgency." |
| 5:45–6:30 | Three judges; sidebar personal leave | Joshi without the guardrail: most hearings, 0% of 5+ year cases moved; with it, a floor. Add a leave day → everything re-plans around it. |
